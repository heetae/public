function selectableForceDirectedGraph() {
    ...
    d3.json("graph.json", function(error, graph) {
        ...
        .attr("x1", function(d) { return 100+(d.source.x)/5; })
        .attr("y1", function(d) { return height+500-(d.source.y)/5; })
        .attr("x2", function(d) { return 100+(d.target.x)/5; })
        .attr("y2", function(d) { return height+500-(d.target.y)/5; })
//        .attr("opacity",0)
...
//        .attr("opacity",0.5);
        ...
        .attr("r", 50)
        .attr("cx", function(d) { return 100+(d.x)/5; })
        .attr("cy", function(d) { return height+500-(d.y)/5; })
            .call(function(elements){elements.each(function(d,i){console.log(d.y)})})
